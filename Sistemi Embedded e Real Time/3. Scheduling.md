...
- HARD Task : non è mai possibile violare una deadline. (conseguenze molto serie)
...
Un sistema operativo in grado di gestire gli hard task chiamato *hard real-time system*, utilizzato solitamente per l'acquisizione di sensori.
